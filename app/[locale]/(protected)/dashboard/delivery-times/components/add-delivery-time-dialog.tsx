      ...
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-none shadow-2xl rounded-2xl">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-default-200">
             <Button 
                className="bg-purple-500 hover:bg-purple-600 text-white rounded-lg px-8 h-12 text-base font-medium flex-1 shadow-lg shadow-purple-500/20 transition-all active:scale-[0.98]"
